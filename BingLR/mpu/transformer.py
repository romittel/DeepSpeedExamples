...
class BertParallelTransformerLayer(torch.nn.Module):
    ...
    def __init__(self,
        ...
        if num_experts == 1:
            ...
            # Use the DeepSpeed API to use MoE layer and experts.
            # -- sharding, comm. and parameter handling will be done inside DeepSpeed
            self.mlp = MoE(hidden_size, output_dropout_prob, BertParallelMLP(hidden_size, output_dropout_prob, init_method, output_layer_init_method=output_layer_init_method), num_experts=num_experts)
