...
run_cmd="LD_PRELOAD=/usr/lib/x86_64-linux-gnu/libnccl.so.2.8.3 deepspeed --num_nodes ${NUM_WORKERS} --num_gpus ${NUM_GPUS_PER_WORKER} load_checkpoint_only_bert_mixture_edit_debug.py $@ ${gpt_options}"
echo ${run_cmd}
eval ${run_cmd}
