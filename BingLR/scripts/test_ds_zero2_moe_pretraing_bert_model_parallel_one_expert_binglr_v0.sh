...
gpt_options=" \
       ...
       --save /relevance2-nfs/romittel/DeepSpeedExamples-amawa-moe/backup_model_test_param_assign \
...
run_cmd="LD_PRELOAD=/usr/lib/x86_64-linux-gnu/libnccl.so.2.8.3 deepspeed --num_nodes ${NUM_WORKERS} --num_gpus ${NUM_GPUS_PER_WORKER} pretrain_only_bert_mixture_v0.py $@ ${gpt_options}"
echo ${run_cmd}
eval ${run_cmd}
