...
gpt_options=" \
       ...
       --save /relevance2-nfs/romittel/DeepSpeedExamples-amawa-moe/backup_models_binglr_v2 \
       ...
       --load /relevance2-nfs/romittel/DeepSpeedExamples-amawa-moe/backup_models_binglr_v2
"
