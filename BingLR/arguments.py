...
def add_model_config_args(parser):
    ...
    group.add_argument('--init-method-std', type=float, default=0.001,
                       help='std of the output initialization')
...
def add_training_args(parser):
    ...
    group.add_argument('--seed', type=int, default=1234,
                       help='random seed')
    group.add_argument('--train-file-lens-path', type=str, default=None,
                       help='Path to a file with the lengths of the training data files.')
...
def add_evaluation_args(parser):
    ...
    group.add_argument('--load-module-strict', type=bool, default='true',
                       help='run validation during training')
    return parser
...
def add_data_args(parser):
    ...
    group.add_argument('--train-data', nargs='+', default=None,
                       ...
                       'for training.')
    group.add_argument('--output-path', type=str, default='output_predictions.txt',
    ...
    group.add_argument('--label-key', default='label',
                       help='key to use to extract label from json/csv')
